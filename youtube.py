...
various_en = ["Channel", "Video", "Playlist"]
...
sort_filtres_en = ["relevance", "raiting", "date", "views"]
language = ["en", "ru"]
...
print("Input your language: ")
time.sleep(3)
lang = fzf.prompt(language)
...
def ru():
    def channel_video_parser(url2, num_page):
        ...
        while True:
            ...
            if "Windows" in os.uname().sysname:
                req.encoding = "1250"
    ...
    ru_various_inpt = fzf.prompt(various)

    if ru_various_inpt[0] == "Канал":
        ...
        videos()
    elif ru_various_inpt[0] == "Плейлист":
...
def english():
        ...
        print("Select type of content for watching: ")
        inpt_various = fzf.prompt(various_en)
        ...
        def playlists():
            ...
            filter = input("Do I need to add a filter (sort by time and more (y/n))? ")
            ...
            if (filter == "д"):
                ...
                print("Select duration filter: ")
                time.sleep(3)
                duration = fzf.prompt(duration_filres)

                print("Select sort filter: ")
                time.sleep(3)
                sort = fzf.prompt(sort_filtres)
                if sort[0] == "":
                    sort[0] = "relevance"
            ...
            page3 = input("Input the number of pages for the playlist (default 1): ")
        ...
        def channels():
            ...
            inpt = fzf.prompt(names_urls)
            page1 = input("Enter the number of pages for the channel (default 1): ")
        ...
        def videos():
            ...
            filter = input("Do I need to add a filter (sort by time, etc (y/n))? ")
        ...
        en_inpt_various = fzf.prompt(various_en)

        if en_inpt_various[0] == "Channel":
            name_of_channel = input("Input name of channel: ")
            page_channel = input("Input the number of pages (default 1): ")
            ...
            channels()
        elif en_inpt_various[0] == "Video":
            title = input("Input name of video: ")
            urls = ""

            page = input("Input the number of pages (default 1): ")
            ...
            videos()
        elif en_inpt_various[0] == "Playlist":
            name_of_playlist = input("Input name of playlist: ")
            page_playlist = input("Input the number of pages (default 1): ")
